...
| `constellation.massspec` | MS domain — mzpeak I/O, peptides, chromatograms, scoring ("Counter"), Koina, EncyclopeDIA | partial (`peptide/` shipped; `tokenize/` scaffold; readers/library/scoring TODO) |
